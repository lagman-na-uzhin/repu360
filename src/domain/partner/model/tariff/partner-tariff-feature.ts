export class PartnerTariffFeatures {
    ...
    getActiveFeatures(): Partial<Record<keyof PartnerTariffFeatures, boolean>> {
        return Object.entries(this)
            .filter(([_, value]) => value === true)
            .reduce((acc, [key]) => {
                acc[key as keyof PartnerTariffFeatures] = true;
                return acc;
            }, {} as Partial<Record<keyof PartnerTariffFeatures, boolean>>);
    }
}
