...
export const AuthProxy = {
    "ME_USE_CASE": `${PREFIX.COMPANY_PROXY}UserMeUseCaseProxy`,
    "EMPLOYEE_LOGIN_USE_CASE": `${PREFIX.USER_PROXY}EmployeeLoginUseCaseProxy`,
    "MANAGER_LOGIN_USE_CASE": `${PREFIX.USER_PROXY}ManagerLoginUseCaseProxy`,
} as const;
